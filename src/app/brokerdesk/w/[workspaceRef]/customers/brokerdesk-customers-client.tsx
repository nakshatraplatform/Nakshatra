...
export function BrokerdeskCustomersClient({ customers }: { customers: BrokerdeskCustomers }) {
  ...
  return <div className={styles.shell}>
    <header><VivIntroBrand href="/brokerdesk" variant="compact-symbol" /><span>BrokerDesk</span><nav><Link href="/brokerdesk">Home</Link><strong>Customers</strong><Link href={`/brokerdesk/w/${available.workspaceRef}/settings/team`}>Settings</Link></nav><ThemeSwitch /></header>
    <main>
