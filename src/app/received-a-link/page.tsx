...
export default function ReceivedALinkPage() {
  return <PolicyLayout eyebrow="For viewers and families" title="Received a VivIntro link? Here is what happens next." summary="You can read the public introduction without an account. Continue only if the introduction feels relevant to you and your family.">
    ...
    <PolicySection title="3. Respect the owner’s decision"><p>The owner can approve the request or set it aside privately. Approved Complete Portfolio access lasts 15 days and may be ended earlier.</p></PolicySection>
    <PolicySection title="Try the experience"><p><Link href="/demo" className="font-semibold text-[color:var(--workspace-teal)] underline underline-offset-4">Open the fictional demo portfolio</Link> to see the format without sharing any personal information.</p></PolicySection>
  </PolicyLayout>;
}
