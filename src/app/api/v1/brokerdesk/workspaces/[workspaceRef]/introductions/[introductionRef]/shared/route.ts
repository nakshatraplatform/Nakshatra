...
import { markBrokerIntroductionShared, BrokerIntroductionError } from "@/features/broker-introductions/server/broker-introduction.service";
...
export async function POST(request: Request, context: Context) {
  try {
    ...
    return NextResponse.json(await markBrokerIntroductionShared(auth.supabase, workspaceRef, introductionRef, body.data.expectedVersion), { headers });
  } catch (error) {
