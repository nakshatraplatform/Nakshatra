...
export default function TrustPage() {
  return <PolicyLayout eyebrow="Trust and safety" title="What VivIntro protects—and what no shared link can promise." summary="Trust starts with accurate boundaries. VivIntro controls disclosure inside the product; it cannot control conversations or screenshots outside it.">
    <PolicySection title="Identity check"><p>A creator completes a hosted identity check before publishing. VivIntro records consent and verification status, but does not copy identity-document images or numbers into the product. A badge is not a guarantee that every portfolio statement is accurate.</p></PolicySection>
    <PolicySection title="Sharing boundary"><p>Anyone who receives or is forwarded a link can open its public introduction. There is no public directory, and portfolio pages are marked not to appear in search results. Sensitive contact details and protected documents require owner approval.</p></PolicySection>
    <PolicySection title="Access and control"><p>Public introductions remain active until their owner unpublishes them. Approved Complete Portfolio access lasts 15 days and can be ended earlier. Owners can approve or set aside each request privately.</p></PolicySection>
