...
| Tour readable at 1440×600 | A 633px card remained sticky below the 78px header | Use a centered single-column, nonsticky tour when desktop viewport height is at most 760px; Chrome checks the last item can be brought into view. |
